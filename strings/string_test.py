...
class StringsTest(unittest.TestCase):
    ...
    def test_contains_with_matching_patterns(self):
        ...
        assert contains('neinien', 'ein') is True
    ...
    def test_contains_with_non_matching_patterns(self):
        ...
        assert contains('allomonafluenza', 'monica') is False
    ...
    def test_contains_with_complex_patterns(self):
        ...
        assert contains('bababab', 'bab') is True
        # multiple overlapping prefixes shifted
        assert contains('sbababababs', 'bab') is True
        assert contains('donkeyyeknod', 'eyy') is True
        assert contains('jumamababaa', 'aba') is True
    ...
    def test_find_index_with_non_matching_patterns(self):
        ...
        assert find_index('jubacca', 'jews') is None
        assert find_index('lolly', 'chigger') is None
    ...
    def test_find_index_with_complex_patterns(self):
        ...
        assert find_index('monkeybuns the third', 'ey') == 4
    ...
    def test_find_all_indexes_with_matching_patterns(self):
        ...
        assert find_all_indexes('whalarhinocerosin-h', 'in') == [7, 15]
    ...
    def test_find_all_indexes_with_non_matching_patterns(self):
        ...
        assert find_all_indexes('flyopotamus', 'cow') == []
    ...
    def test_find_all_indexes_with_complex_patterns(self):
        ...
        assert find_all_indexes('monkeyosaurus-rex', 'e') == [
            4, 15]
